    ...
    <header className="sticky top-0 z-40 bg-paper/70 backdrop-blur-md dark:bg-ink/70">
      <div className="mx-auto flex w-full max-w-4xl items-center justify-between gap-3 px-4 py-4 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <span aria-hidden className="text-muted dark:text-muted-dark hidden sm:inline">·</span>
          <a
            href="https://github.com/aurorascharff"
            target="_blank"
            rel="noreferrer noopener"
            className="text-muted dark:text-muted-dark hover:text-ink dark:hover:text-paper hidden text-sm transition-colors sm:inline"
          >
            by Aurora Scharff
          </a>
        </div>
        <nav className="flex items-center gap-1">
          <a
            ...
            className="text-muted dark:text-muted-dark hover:text-ink dark:hover:text-paper inline-flex h-9 w-9 items-center justify-center rounded-md transition-colors"
          >
